...
def generar_pdf(datos, x, y, filename):
    ...
    # Título del documento (opcional, para dar contexto)
    pdf.set_font("Arial", "B", 14)
    pdf.cell(0, 10, "Informe Preliminar de Afecciones", ln=True, align="C")
    pdf.ln(10)
    ...
    # Añadir el texto en un cuadro
    pdf.multi_cell(170, 8, texto_aviso, border=1, align="L")
